...
class HotelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hotel" do
    assert_difference("Hotel.count") do
      post hotels_url, params: { hotel: { booked_rooms: @hotel.booked_rooms, location: @hotel.location, name: @hotel.name, total_rooms: @hotel.total_rooms } }
    end
  ...
  test "should update hotel" do
    patch hotel_url(@hotel), params: { hotel: { booked_rooms: @hotel.booked_rooms, location: @hotel.location, name: @hotel.name, total_rooms: @hotel.total_rooms } }
